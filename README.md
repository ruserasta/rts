...
- Tasks module now supports:
  - server-side loading from Supabase (with mock fallback)
  - add-task server action with permission checks (manager/account manager)
  - kanban board with overdue highlighting and stage empty states
